...
root.title('Translator Made By Hridoy')
...
label1 = Label(root,text="Enter Words :",font=('times',15,'italic bold'),bg='orange')
label1.place(x=5,y=40)

label2 = Label(root,text="Translated :",font=('times',15,'italic bold'),bg='orange')
label2.place(x=5,y=100)

label3 = Label(root,text=" ",font=('times',15,'italic bold'),bg='orange')
...
btn1 = Button(root,text='Click',bd=10,bg='green',activebackground='red',width=50,font=('times',15,'italic bold'),image=imgbt1, command='RIGHT,tt')
btn1.place(x=70,y=170)

btn2 = Button(root,text='Exit',bd=10,bg='green',activebackground='red',width=50,font=('times',15,'italic bold'),image=imgbt2,command='RIGHT')
